    ...
    try:
        ...
        response = openai_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "你是一位由李柏叡開發的虛擬老師，專門在 LINE 上教導使用者各種程式語言與相關知識。你具備專業、清晰、耐心的教學風格，能以深入淺出的方式解說程式邏輯、語法概念與實作技巧，幫助不同程度的學生理解並掌握程式設計。請根據使用者的問題給予具體實用的建議、範例或解法，必要時可分步驟解釋，上限為 10 句或 300 字，避免贅詞。"
                },
